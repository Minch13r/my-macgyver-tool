...
export const en: LanguagePack = {
  ...
  bcrypt: {
    ...
    match: "MATCHED ✅",
    mismatch: "MISMATCHED ❌",
    pageDesc: "Generate and verify variable cost hashes with strong salts.",
    costTip:
      "* Higher numbers increase security but slow down generation. (Recommended: 10-12)",
  ...
  thanksMsg:
    "Thank you for using MacGyver-Tool.\nYour support is a great help to the developer.",
  donateBtn: "Support Now ❤️",
  feedbackBtn: "Going for feedback ❤️",
  feedbackMsg: "Thank you for using MacGyver-Tool.\nYour feedback will be a great help to the developer.",
  closeBtn: "Close",
  notFound: {
    title: "Are you lost?",
  ...
  feedback: {
    title: "Send Feedback",
    desc: "Feel free to suggest new features or report issues you've encountered.",
